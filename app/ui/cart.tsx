...
export default function Cart() {
    ...
    const { isOpen, cartItems, setIsOpen, setCartItems, deleteCartItem } = useCart()
        ...
        <>
            <div className="cart" style={{ display: isOpen ? 'flex' : 'none' }}>
                <div className="cart-body">
                        ...
                        {cartItems.map(product => (
                            <div className="card" key={product.id}>
                                ...
                                <div className="card-body justify-content-between">
                                    ...
                                    <button className="btn btn-primary" onClick={() => deleteCartItem(product.id)}>Удалить</button>
                                </div>
                            </div>
                    ...
                    <button className="btn btn-primary cart-confirm" onClick={() => (setCartItems([]), setIsOpen(false))}>Оформить заказ</button>
